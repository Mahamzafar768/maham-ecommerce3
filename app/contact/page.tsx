...
const Contact = () => {
  return (
    <>
      <section className="text-gray-600 body-font relative bg-gradient-to-r from-blue-100">
            ...
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                ...
                <span className="inline-flex justify-center space-x-4">
                  ...
                  <Link href="https://www.twitter.com" className="text-gray-500">
                    <FaTwitter size={20} />
                  </Link>
                  <Link href="https://www.linkedin.com" className="text-gray-500">
                    <FaLinkedin size={20} />
                  </Link>
